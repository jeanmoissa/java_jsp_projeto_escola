...
<html>
    <head>
        ...
        <title>Lista de Perfil de Inteligencia</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <table class="table table-sm table-striped mt-3 text-center table-bordered" 1px>
                <legend class="h3 mt-3">Perfil de Inteligências Multiplas</legend><br>
                <thead>
                    <tr>
                        <th class="table-dark" scope="col">E-mail</th>
                        <th class="table-dark" scope="col">Linguistica</th>
                        <th class="table-dark" scope="col">Matematica</th>
                        <th class="table-dark" scope="col">Visual</th>
                        <th class="table-dark" scope="col">Cinestesica</th>
                        <th class="table-dark" scope="col">Musical</th>
                        <th class="table-dark" scope="col">Interpessoal</th>
                        <th class="table-dark" scope="col">Intrapessoal</th>
                        <th class="table-dark" scope="col">Aplicada</th>
                        <th class="table-dark" scope="col">Estrategica</th>
                ...
                <tbody>
                    ...
                    <%
                        try {
                            ...
                            result = statement.executeQuery("SELECT perfilInteligencia.idPerfilInteligencia,alunos.email,perfilInteligencia.intLinguistica,perfilInteligencia.intMatematica,perfilInteligencia.intVisual,perfilInteligencia.intCinestesica,perfilInteligencia.intMusical,PerfilInteligencia.intInterpessoal,PerfilInteligencia.intIntrapessoal,PerfilInteligencia.intAplicada,PerfilInteligencia.intEstrategica FROM perfilInteligencia INNER JOIN alunos ON perfilInteligencia.idAluno = alunos.idAluno; ");
...
<%  /*BOTAO EXCLUIR*/
    if (request.getParameter("funcao") != null && request.getParameter("funcao").equals("excluir")) {
        ...
        try {
            statement = new Conexao().conectar().createStatement();
            statement.executeUpdate("DELETE FROM perfilInteligencia WHERE idPerfilInteligencia = '" + id + "'");
            statement.executeUpdate("UPDATE Alunos SET perfilInteligencia = 'N' WHERE idAluno = '" + idUsuario + "'");
            response.sendRedirect("listaPerfilInteligencia.jsp");
