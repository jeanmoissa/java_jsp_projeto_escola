...
<html>
    <head>
        ...
        <title>Lista de QP e Sabotadores</title>
    ...
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="listaPerfilQPeSabotadores.jsp">07. QP e Sabotadores</a>
                        </div>
                    </li>
                </ul>
        ...
        <div class="container-fluid">
            ...
            <table class="table table-sm table-striped mt-3 text-center table-bordered" 1px>
                <legend class="h3 mt-3">Perfil de QP e Sabotadores</legend><br>
                <thead>
                    <tr>
                        <th class="table-dark" scope="col">E-mail</th>
                        <th class="table-dark" scope="col">QP</th>
                        <th class="table-dark" scope="col">S1</th>
                        <th class="table-dark" scope="col">S2</th>
                        <th class="table-dark" scope="col">S3</th>
                        <th class="table-dark" scope="col">S4</th>
                        <th class="table-dark" scope="col">S5</th>
                        <th class="table-dark" scope="col">S6</th>
                        <th class="table-dark" scope="col">S7</th>
                        <th class="table-dark" scope="col">S8</th>
                        <th class="table-dark" scope="col">S9</th>
                        <th class="table-dark" scope="col">C1</th>
                        <th class="table-dark" scope="col">C2</th>
                        <th class="table-dark" scope="col">C3</th>
                ...
                <tbody>
                    ...
                    <%
                        try {
                            ...
                            result = statement.executeQuery("SELECT perfilQPeSabotadores.idPerfilQPeSabotadores,alunos.email,perfilQPeSabotadores.qp,perfilQPeSabotadores.s1,perfilQPeSabotadores.s2,perfilQPeSabotadores.s3,perfilQPeSabotadores.s4,perfilQPeSabotadores.s5,perfilQPeSabotadores.s6,perfilQPeSabotadores.s7,perfilQPeSabotadores.s8,perfilQPeSabotadores.s9,perfilQPeSabotadores.c1,perfilQPeSabotadores.c2,perfilQPeSabotadores.c3 FROM perfilQPeSabotadores INNER JOIN alunos ON perfilQPeSabotadores.idAluno = alunos.idAluno; ");
                    ...
                    <tr>
                        ...
                        <td>
                           <!-- <a href="listaPerfilRepresentacional.jsp?funcao=editar&id=<%= result.getString(1)%>" class="text-info"> <i class="far fa-edit"></i> </a> -->
                            <a href="listaPerfilQPeSabotadores.jsp?funcao=excluir&id=<%= result.getString(1)%>" class="text-danger"> <i class="far fa-trash-alt"></i></i> </a>
                        </td>
                    </tr>
...
<%  /*BOTAO EXCLUIR*/
    if (request.getParameter("funcao") != null && request.getParameter("funcao").equals("excluir")) {
        ...
        try {
            statement = new Conexao().conectar().createStatement();
            statement.executeUpdate("DELETE FROM perfilQPeSabotadores WHERE idperfilQPeSabotadores = '" + id + "'");
            statement.executeUpdate("UPDATE Alunos SET perfilQPeSabotadores = 'N' WHERE idAluno = '" + idUsuario + "'");
            response.sendRedirect("listaPerfilQPeSabotadores.jsp");
