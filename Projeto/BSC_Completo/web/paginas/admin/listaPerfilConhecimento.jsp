...
<html>
    <head>
        ...
        <title>Lista Perfil de Conhecimento</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <table class="table table-sm table-striped mt-3 text-center table-bordered" 1px>
                <legend class="h3 mt-3">Perfil De Áreas de Conhecimento</legend><br>
                <thead>
                    <tr>
                        <th class="table-dark" scope="col">E-mail</th>
                        <th class="table-dark" scope="col">Area Pretendida</th>
                        <th class="table-dark" scope="col">Essencial</th>
                        <th class="table-dark" scope="col">Web Dev</th>
                        <th class="table-dark" scope="col">Front-End</th>
                        <th class="table-dark" scope="col">Back-End</th>
                        <th class="table-dark" scope="col">DevOps</th>
                ...
                <tbody>
                    ...
                    <%
                        try {
                            ...
                            result = statement.executeQuery("SELECT perfilConhecimento.idPerfilConhecimento,alunos.email,perfilConhecimento.areaPretendida,perfilConhecimento.pcEssencial,perfilConhecimento.pcWebDev,perfilConhecimento.pcFrontEnd,perfilConhecimento.pcBackEnd,PerfilConhecimento.pcDevOps,PerfilConhecimento.resultadoConhecimento FROM perfilConhecimento INNER JOIN alunos ON perfilConhecimento.idAluno = alunos.idAluno; ");
                    ...
                    <tr>
                        ...
                        <td>
                           <!-- <a href="listaPerfilComportamental.jsp?funcao=editar&id=<%= result.getString(1)%>" class="text-info"> <i class="far fa-edit"></i> </a> -->
                            <a href="listaPerfilConhecimento.jsp?funcao=excluir&id=<%= result.getString(1)%>" class="text-danger"> <i class="far fa-trash-alt"></i></i> </a>
                        </td>
                    </tr>
...
<%  /*BOTAO EXCLUIR*/
    if (request.getParameter("funcao") != null && request.getParameter("funcao").equals("excluir")) {
        ...
        try {
            statement = new Conexao().conectar().createStatement();
            statement.executeUpdate("DELETE FROM perfilConhecimento WHERE idPerfilConhecimento = '" + id + "'");
            statement.executeUpdate("UPDATE Alunos SET perfilConhecimento = 'N' WHERE idAluno = '" + idUsuario + "'");
            response.sendRedirect("listaPerfilConhecimento.jsp");
